...
if (!$result) {
  ...
  // Prepare the SQL statement to insert or update marks in the nine_neb table
  $sql = "INSERT INTO ten_neb (roll_no, nepali, english, maths, science, social, hpe, omaths, computer, economics, geography, gpa) VALUES ('$rollNo', '$nine_neb[0]', '$nine_neb[1]', '$nine_neb[2]', '$nine_neb[3]', '$nine_neb[4]', '$nine_neb[5]', '$nine_neb[6]', '$nine_neb[7]', '$nine_neb[8]', '$nine_neb[9]', '$gpa')";
  $result = mysqli_query($conn, $sql);
